...
class Product(models.Model):
    ...
    def get_html_price(self):
        if self.variation_set.first().sale_price is not None:
            html_price='<h3 id="price">%s <small class="org-price" id="price"> %s</small></h3>'%(self.variation_set.first().sale_price,self.variation_set.first().price)
        else:
...
class Variation(models.Model):
    ...
    def get_html_price(self):
        if self.sale_price is not None:
            html_price='<h3 id="price">%s <small class="org-price" id="price"> %s</small></h3>'%(self.sale_price,self.price)
        else:
